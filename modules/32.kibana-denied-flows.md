...
#### <div align="right">  [Click Next -> Lesson 19 - Remediate Security Policies to Permit Denied Flows](https://github.com/Pooriya-a/quickstart-self-service/blob/main/modules/33.remediate-security-policies.md) </div>
