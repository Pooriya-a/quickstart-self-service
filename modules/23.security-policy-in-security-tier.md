...
#### <div align="right">  [Click Next -> Lesson 10 - Security Policies in the Platform Tier](https://github.com/Pooriya-a/quickstart-self-service/blob/main/modules/24.security-policy-in-platform-tier.md) </div>
